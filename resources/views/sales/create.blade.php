    ...
    <div class="row form-row">
        <div class="col-12">
            <div class="form-group">
                <label>{{ __('app.common.product') }} <span class="text-danger">*</span></label>
                <select class="select2 form-select form-control edit_product" name="product">
                    <option value="" selected disabled>{{ __('app.sales.select_product') }}</option>
        ...
        <div class="col-12">
            <div class="form-group">
                <label>{{ __('app.common.quantity') }}</label>
